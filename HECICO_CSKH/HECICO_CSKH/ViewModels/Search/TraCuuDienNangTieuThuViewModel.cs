...
{
   public  class TraCuuDienNangTieuThuViewModel :BaseViewModel 
    {
        #region "Field"
        DateTime _fromdate;
        DateTime _todate;
        ObservableCollection<TraCuuDienNangTieuThuModel> _listTraCuu;
        ...
        public ObservableCollection<TraCuuDienNangTieuThuModel> ListTraCuu { get => _listTraCuu; set => SetProperty(ref _listTraCuu, value); }
        ...
        public TraCuuDienNangTieuThuViewModel() 
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    using (HttpClient client = new HttpClient())
                    {
                        ...
                        var ok = client.PostAsJsonAsync("api/getdiennangtieuthu", khang);
                        ...
                        if (_json.Contains("error") == false && _json.Contains("[]") == false)
                        {
                            ...
                            ListTraCuu = JsonConvert.DeserializeObject<ObservableCollection<TraCuuDienNangTieuThuModel>>(result);
                            HideLoading();
                        }
                        else
                        {
